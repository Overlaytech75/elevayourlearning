...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Bangers&family=Comic+Neue:wght@400;700&family=DM+Sans:opsz,wght@9..40,400;9..40,500;9..40,600;9..40,700&display=swap",
      },
    ],
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          <header className="sticky top-0 z-20 flex h-14 items-center gap-2 border-b border-border/60 bg-card text-card-foreground/40 px-3 backdrop-blur-xl">
            ...
            <div className="ml-1 flex min-w-0 flex-1 items-center gap-2 truncate text-sm text-muted-foreground">
              <img src="/logo.png" alt="Eleva logo" className="h-10 w-10 shrink-0 object-contain" />
              <span className="font-display text-2xl font-bold text-foreground tracking-widest">Eleva</span>
